...
_int_08_hand:				; Handler de INT 8 ( Timer tick)
		...
		call HopOffPages            ;Se bajan todas la páginas del proceso que se estaba ejecutando.

		call GetNextProcess

		push eax
		call TakeUpPages		     ;Se suben todas las páginas del proceso que se va a ejecutar.
